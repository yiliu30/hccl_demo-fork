...
node0:
	HCCL_COMM_ID=10.239.128.244:6006 python3 run_hccl_demo.py --test all_reduce --nranks 16 --loop 1000 --node_id 0 --size 32m --ranks_per_node 8
node1:
	HCCL_COMM_ID=10.239.128.244:6006 python3 run_hccl_demo.py --test all_reduce --nranks 16 --loop 1000 --node_id 1 --size 32m --ranks_per_node 8
